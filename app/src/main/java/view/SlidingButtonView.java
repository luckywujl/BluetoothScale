...
public class SlidingButtonView extends HorizontalScrollView {
    ...
    private Boolean isOpen = false;      //删除按钮是否开启状态标记

    private TextView lTextView_Delete,lTextView_Modify;      //删除按钮
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(!first){
            ...
            lTextView_Modify = (TextView) findViewById(R.id.tv_modify);
            first = true;
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(changed){
            ...
            lScrollWidth = lTextView_Delete.getWidth()+lTextView_Modify.getWidth();
        }
